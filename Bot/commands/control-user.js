  ...
  execute(message, client) {
    ...
    if (
      ...
      return message.reply(
        `**❌ Example: \`${prefix}control-user [add/remove] [user]\`**`
      );
    const user =
    ...
    if (args[1] == "add") {
      ...
      if (
        db1.get({ key: `${message.guild.id}_CONTROLUSERS` }).includes(user.id)
      )
        return message.reply({
          content: `**❌ This User Is Already In Control Users**`,
        });
      ...
      message.reply({
        content: `✅ **Sunccessfully Added ${user} To Control Users**`,
      });
      ...
      if (
        ...
        return message.reply({
          content: `**❌ This User Isn't In Control Users**`,
        });
      ...
      message.reply({
        content: `**✅ Sunccessfully Removed ${user} From Control Users**`,
      });
